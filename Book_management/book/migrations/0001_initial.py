    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(blank=True, choices=[('available', 'Available'), ('sold', 'Sold'), ('out_of_stock', 'Out of Stock'), ('reserved', 'Reserved'), ('pending_approval', 'Pending Approval')], max_length=50, null=True)),
